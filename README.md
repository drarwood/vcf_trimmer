...
The default instance type is `mem1_ssd1_v2_x36`. Benchmarking has been based on this server type for the 200K WGS data and you should limit the maximum number of concurrent VCFs processed at a time to `20` to avoid resource issues. For other datasets, you may need to adjust this limit.
```
